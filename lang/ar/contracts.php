...
return [
    ...
    'contract_duration_months' => 'مدة العقد بالشهور',
    'total_rent_amount' => 'قيمة الإيجار الكلي (مدة العقد)',
    ...
    // Snapshots & Utilities
    'electricity_and_water_numbers' => 'أرقام الكهرباء والماء',
    'utilities_snapshot_hint' => 'هذه الأرقام هي التي ستطبع في جدول الوورد. عدد العدادات يحدد عدد صفوف الجدول. التعديل هنا لا يغير بيانات العدادات الأصلية في النظام.',
    'unit_name' => 'اسم الوحدة',
    'electricity' => 'الكهرباء',
    'water' => 'الماء',
    'monthly_unit_rent' => 'ايجار الوحدة الشهري',
    'unit_deposit' => 'تأمين الوحدة',
    'no_utilities_data' => 'لا توجد بيانات عدادات مسجلة لهذا العقد.',
    'party_one_company_owner' => 'الطرف الأول (الشركة / المالك)',
    'party_one_snapshot_hint' => 'هذه البيانات ستطبع في العقد كـ "الطرف الأول". التعديل هنا فقط للطباعة.',
    'party_one_name_ar' => 'اسم الطرف الأول (عربي)',
    'party_one_name_en' => 'اسم الطرف الأول (إنجليزي)',
    'party_two_tenant' => 'الطرف الثاني (المستأجر)',
    'party_two_snapshot_hint' => 'هذه البيانات ستطبع في العقد كـ "الطرف الثاني".',
    'party_two_name_ar' => 'اسم الطرف الثاني (عربي)',
    'party_two_name_en' => 'اسم الطرف الثاني (إنجليزي)',
    'id_or_passport_number' => 'رقم الهوية/الجواز',
    'mobile_number' => 'رقم الجوال',
    'property_data' => 'بيانات العقار',
    'zone_number' => 'رقم المنطقة',
    'street_number_name' => 'رقم / اسم الشارع',
    'building_number' => 'رقم المبنى',
    'title_deed_number' => 'رقم سند الملكية',

    // Smart Tags extras
    'tag_unit_rent_amount' => 'إيجار الوحدة (للجدول)',
    'tag_unit_deposit_amount' => 'تأمين الوحدة (للجدول)',
    'smart_tags_copied' => 'تم نسخ الكود بنجاح!',
