...
<?php $__env->startSection('content'); ?>
    <div class="app-content content">
        <form class="form ajax-form" id='myForm' action="<?php echo route('dashboard.roles.store'); ?>" method="post" enctype="multipart/form-data" novalidate
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="alert alert-icon-left alert-arrow-left alert-info mb-3 shadow-sm border-0" role="alert" style="border-radius: 12px;">
                                                    ...
                                                    <h6 class="alert-heading font-weight-bold mb-1"><?php echo __('general.pro_tip'); ?></h6>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-md-12">
                                                        <div class="premium-form-group">
                                                            <label for="company_id" class="premium-label"><?php echo __('companies.company'); ?></label>
                                                ...
                                                <div class="row mb-4px">
                                                    <div class="col-md-6 mb-2">
                                                        <div class="premium-form-group">
                                                            <label for="name_ar"
                                                                class="premium-label"><?php echo __('roles.role_ar'); ?> <span class="text-danger">*</span></label>
                                                            <input type="text" id="name_ar" name="name[ar]"
                                                                value="<?php echo old('name.ar'); ?>"
                                                                class="form-control premium-input shadow-none"
                                                                autocomplete="off"
                                                                placeholder="<?php echo __('roles.enter_role_ar'); ?>">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="premium-form-group">
                                                            <label for="name_en"
                                                                class="premium-label"><?php echo __('roles.role_en'); ?> <span class="text-danger">*</span></label>
                                                            <input type="text" id="name_en" name="name[en]"
                                                                value="<?php echo old('name.en'); ?>"
                                                                class="form-control premium-input shadow-none"
                                                                autocomplete="off"
                                                                placeholder="<?php echo __('roles.enter_role_en'); ?>">
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <div class="premium-form-group">
                                                            ...
                                                            <input type="text" id="description" name="description"
                                                                ...
                                                                class="form-control premium-input shadow-none"
                                                                autocomplete="off"
                                                                placeholder="<?php echo __('roles.enter_description') ?? 'ادخل وصفاً لهذا الدور...'; ?>">
                                                ...
                                                <div class="row mt-4px">
                                                    <div class="col-md-12">
                                                        <h5 class="premium-section-title d-flex align-items-center justify-content-between">
                                                            <span>
                                                                <i class="fas fa-key"></i> <?php echo __('roles.permissions'); ?> <span class="text-danger">*</span>
                                                            </span>
                                                        ...
                                                        <div class="permissions-grid">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = config('global.modules'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleKey => $moduleLangKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->id === 1 || auth()->user()->role_id === 1 || Gate::allows($moduleKey)): ?>
                                                                    <div class="permission-card">
                                                                        <div class="permission-card-header">
                                                                            <div class="permission-card-title">
                                                                                <i class="<?php echo e(config('global.module_icons.' . $moduleKey, 'la la-dot-circle')); ?>"></i>
                                                                                <?php echo __($moduleLangKey); ?>

                                                                            </div>
                                                                            <label class="modern-switch">
                                                                                <input type="checkbox" class="select-all-module" data-module="module-<?php echo e($moduleKey); ?>">
                                                                        ...
                                                                        <div class="permission-card-body">
                                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = config('global.crud_operations'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opKey => $opLangKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                ...
                                                                                <?php if(auth()->user()->id === 1 || auth()->user()->role_id === 1 || auth()->user()->hasAbility($permName)): ?>
                                                                                    <div class="permission-item">
                                                                                        <div class="permission-info">
                                                                                            <label class="permission-label"><?php echo __($opLangKey); ?></label>
                                                                                            <p class="permission-desc"><?php echo __($opLangKey . '_desc'); ?></p>
                                                                                        </div>
                                                                                        <label class="modern-switch">
                                                                                            <input type="checkbox" class="permission-checkbox module-<?php echo e($moduleKey); ?>" name="permissions[]" value="<?php echo e($permName); ?>">
                                                                                            <span class="modern-slider"></span>
                                                                                        </label>
                                                                                    </div>
                                                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rental\resources\views/dashboard/roles/create.blade.php ENDPATH**/ ?>