<div class="modal modal-pop" id="createDepartmentModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form class="form ajax-form" action="<?php echo route('dashboard.departments.store'); ?>" method="POST" enctype="multipart/form-data"
            ...
            <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
                ...
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center" id="createDepartmentModalLabel">
                        <i class="fas fa-plus-circle text-primary mr-2 icon-size-18"></i> <?php echo __('departments.create_new_department'); ?>
                ...
                <div class="modal-body my-2">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-1">
                            <div class="premium-form-group">
                                <label class="premium-label" for="company_id_dept_create"><?php echo __('companies.company'); ?> <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_ar_create"><?php echo __('departments.name_ar'); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_en_create"><?php echo __('departments.name_en'); ?> <span class="text-danger">*</span></label>
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/departments/modals/create.blade.php ENDPATH**/ ?>