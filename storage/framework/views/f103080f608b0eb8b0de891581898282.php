            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center"
                        ...
                        <?php echo e(__('owners.add_owner')); ?>
                            ...
                            <div class="col-md-12">
                                <div class="premium-form-group mb-0">
                                    <label class="font-weight-bold text-primary"><i class="fas fa-search mr-1"></i>
                                        <?php echo __('owners.search_existing_owner'); ?></label>
                                    <div class="premium-input-wrapper">
                                        <div class="position-relative w-100">
                                            <input type="text" wire:model.live.debounce.300ms="searchTerm"
                                                class="form-control premium-input shadow-none"
                                                placeholder="<?php echo __('owners.search_by_id_name_phone'); ?>" autocomplete="off">
                                                                ...
                                                                <ul class="select2-results__options" role="listbox">
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($searchResults) > 0): ?>
                                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $searchResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <li class="select2-results__option py-2 px-3"
                                                                                role="option"
                                                                                wire:click="selectOwner(<?php echo e($result['id']); ?>)"
                                                                                ...
                                                                                -
                                                                                <?php echo e($result['identification_number'] ?? ''); ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <li class="select2-results__option select2-results__message"
                                                                            role="option">
                                                                            <?php echo e(__('owners.no_owners_found')); ?>
                                    ...
                                    <small class="text-muted d-block mt-1"><?php echo __('owners.search_hint_or_add_new'); ?></small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="premium-form-group">
                                    <label class="font-weight-bold"><?php echo __('owners.name_ar'); ?>

                                        <span class="text-danger">*</span></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_name.ar'];
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" wire:model.defer="quick_name.ar"
                                            class="form-control premium-input shadow-none"
                                            placeholder="<?php echo e(__('owners.enter_name_ar')); ?>"
                                            autocomplete="off"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="premium-form-group">
                                    <label class="font-weight-bold"><?php echo __('owners.name_en'); ?> <span
                                            class="text-danger">*</span></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_name.en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid-premium <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" wire:model.defer="quick_name.en"
                                            class="form-control premium-input shadow-none"
                                            placeholder="<?php echo e(__('owners.enter_name_en')); ?>"
                                            autocomplete="off"
                                            <?php echo e($is_existing ? 'readonly' : ''); ?>>
                                        <i class="fas fa-user text-primary"></i>
                                    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="premium-form-group">
                                    <label class="font-weight-bold"><?php echo __('owners.identification_number'); ?> <span
                                            class="text-danger">*</span></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_id_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid-premium <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" wire:model.defer="quick_id_number"
                                            class="form-control premium-input shadow-none"
                                            placeholder="<?php echo e(__('owners.enter_id_number')); ?>"
                                            autocomplete="off"
                                            <?php echo e($is_existing ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="premium-form-group">
                                    <label class="font-weight-bold"><?php echo __('owners.phone'); ?> <span
                                            class="text-danger">*</span></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid-premium <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" wire:model.defer="quick_phone"
                                            class="form-control premium-input shadow-none"
                                            placeholder="<?php echo e(__('owners.enter_phone')); ?>"
                                            autocomplete="off"
                                            <?php echo e($is_existing ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="premium-form-group">
                                    <label class="font-weight-bold"><?php echo __('owners.email'); ?></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid-premium <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="email" wire:model.defer="quick_email"
                                            class="form-control premium-input shadow-none"
                                            placeholder="<?php echo e(__('owners.enter_email')); ?>"
                                            autocomplete="off"
                                            <?php echo e($is_existing ? 'readonly' : ''); ?>>
                                        <i class="fas fa-envelope text-info"></i>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['quick_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="premium-form-group">
                                    <label class="font-weight-bold"><?php echo __('owners.address'); ?></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid-premium <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <input type="text" wire:model.defer="quick_address"
                                            class="form-control premium-input shadow-none"
                                            placeholder="<?php echo e(__('owners.enter_address')); ?>"
                                            autocomplete="off"
                                            <?php echo e($is_existing ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="premium-form-group">
                                    <label class="font-weight-bold"><?php echo __('properties.ownership_percentage'); ?></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid-premium <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['quick_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="premium-form-group mb-2 w-100">
                                    <div class="d-flex align-items-center h-100 mt-4 px-2">
                                        ...
                                        <label class="font-weight-bold text-dark cursor-pointer mb-0"
                                            ...
                                            <?php echo __('properties.is_primary'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-0">
                                <div class="premium-form-group mb-0">
                                    <label class="font-weight-bold"><?php echo __('owners.notes'); ?></label>
                                    <div
                                        class="premium-input-wrapper <?php $__errorArgs = ['quick_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid-premium <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <textarea wire:model.defer="quick_notes" class="form-control premium-input h-80 shadow-none"
                                            placeholder="<?php echo e(__('owners.notes')); ?>" <?php echo e($is_existing ? 'readonly' : ''); ?>></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="modal-footer border-0 pt-0 premium-modal-footer">
                        <button type="submit"
                            ...
                            <?php echo __('properties.add_owner'); ?>
...
<?php /**PATH C:\laragon\www\rental\resources\views/livewire/dashboard/properties/quick-owner-modal.blade.php ENDPATH**/ ?>