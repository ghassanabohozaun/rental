...
<?php $__env->startSection('content'); ?>
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-contracts">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['total_users']); ?></h3>
                                <h6 class="stat-title"><?php echo __('users.users'); ?></h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-active">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['active_users']); ?></h3>
                                <h6 class="stat-title"><?php echo __('users.active_users'); ?></h6>
                            </div>
                            <div class="stat-icon-wrapper">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-revenue">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['managers']); ?></h3>
                                <h6 class="stat-title"><?php echo __('users.managers'); ?></h6>
                            </div>
                            <div class="stat-icon-wrapper">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-expiring">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['super_users']); ?></h3>
                                <h6 class="stat-title"><?php echo __('users.super_users'); ?></h6>
                            </div>
                            <div class="stat-icon-wrapper">
                ...
                <!-- end: stats cards -->
                <?php echo $__env->make('dashboard.users.partials._search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <div class="card premium-card">
                                ...
                                <div class="card-header border-0 pb-0">
                                    <h6 class="card-title text-dark font-weight-bold d-flex align-items-center mb-0">
                                        ...
                                        <span id="usersCountBadge" class="badge badge-primary badge-pill badge-glow ml-2 font-11"><?php echo $users->total(); ?></span>
                                    </h6>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="table-loader-container">
                                            ...
                                            <div id="table_data">
                                                <?php echo $__env->make('dashboard.users.partials._table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <?php echo $__env->make('dashboard.users.modals.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.users.modals.edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('dashboard.users.modals.details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('change', '.change_status', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('dashboard.users.change.status')); ?>",
                    data: {
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rental\resources\views/dashboard/users/index.blade.php ENDPATH**/ ?>