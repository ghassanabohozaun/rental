        ...
        <form class="js-filter-form d-flex align-items-center gap-2" data-container="#table_data"
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="keyword_search_popover">
                    <div class="mb-3">
                        <label class="premium-label mb-2"><?php echo __('property_types.property_types'); ?></label>
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/property_types/partials/_search.blade.php ENDPATH**/ ?>