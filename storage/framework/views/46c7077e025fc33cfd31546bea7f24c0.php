        ...
        <form class="js-filter-form d-flex align-items-center gap-2" data-container="#table_data"
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="keyword_search_popover">
                    <div class="mb-3">
                        <label class="premium-label mb-2"><?php echo __('departments.departments'); ?></label>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="premium-input-wrapper">
                                <select name="company_id" id="filter_company_id"
                                    ...
                                    data-placeholder="<?php echo __('general.all_companies'); ?>" data-parent="#company_search_popover">
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/departments/partials/_search.blade.php ENDPATH**/ ?>