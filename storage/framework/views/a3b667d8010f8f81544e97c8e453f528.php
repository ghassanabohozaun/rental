        ...
        <form class="js-filter-form d-flex align-items-center gap-2" data-container="#table_data"
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="keyword_search_popover">
                    <div class="mb-3">
                        <label class="premium-label mb-2"><?php echo __('property_statuses.property_statuses'); ?></label>
                        <div class="premium-input-wrapper">
                            <input type="text" class="form-control premium-input shadow-none"
                                name="keyword" placeholder="<?php echo __('general.search'); ?>..."
                                autocomplete="off">
                            <i class="fas fa-search text-primary"></i>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/property_statuses/partials/_search.blade.php ENDPATH**/ ?>