<div class="modal modal-pop" id="editBankAccountModal" tabindex="-1" role="dialog" data-backdrop="static"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form class="form ajax-form" action="" method="POST" enctype="multipart/form-data"
            id='edit_bank_account_form' novalidate data-success-msg="<?php echo __('general.update_success_message'); ?>"
            ...
            <div class="modal-content shadow-lg premium-modal-content">
                ...
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center"
                        ...
                        <i class="fas fa-edit text-primary mr-2 icon-size-18"></i> <?php echo __('bank_accounts.update_bank_account'); ?>
                ...
                <div class="modal-body my-2">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-1">
                                <div class="premium-form-group">
                                    <label class="premium-label" for="company_id_bank_edit"><?php echo __('companies.company'); ?> <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="bank_name_ar_edit"><?php echo __('bank_accounts.bank_name_ar'); ?> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="bank_name_en_edit"><?php echo __('bank_accounts.bank_name_en'); ?> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="account_holder_name_ar_edit"><?php echo __('bank_accounts.account_holder_name_ar'); ?> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="account_holder_name_en_edit"><?php echo __('bank_accounts.account_holder_name_en'); ?> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="account_number_edit"><?php echo __('bank_accounts.account_number'); ?> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="iban_edit"><?php echo __('bank_accounts.iban'); ?></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.editBankAccountBtn', function(e) {
                ...
                var actionUrl = "<?php echo route('dashboard.bank-accounts.update', ':id'); ?>";
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/bank_accounts/modals/edit.blade.php ENDPATH**/ ?>