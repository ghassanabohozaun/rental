...
<?php $__env->startSection('content'); ?>
    <div class="app-content content">
        <div class="content-wrapper">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb premium-breadcrumb shadow-sm">
                                ...
                                <li class="breadcrumb-item active">
                                    <i class="fas fa-briefcase mr-1 pointer-events-none"></i> <?php echo __('property_types.property_types'); ?>
                ...
                <div class="content-header-right col-md-6 col-12 text-md-right">
                    <div class="mb-1">
                        <button type="button" class="btn btn-premium-add shadow-pulse h-42 radius-10" data-toggle="modal"
                            ...
                            <?php echo __('property_types.create_new_property_type'); ?>
            ...
            <?php echo $__env->make('dashboard.property_types.partials._search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                ...
                                <div class="card-header border-0 pb-0">
                                    <h4 class="card-title text-dark font-weight-bold d-flex align-items-center">
                                        ...
                                        <span id="property_typesCountBadge"
                                            class="badge badge-primary badge-pill badge-glow ml-2 font-11"><?php echo $property_types->total(); ?></span>
                                    </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body pt-0">
                                        <div class="table-loader-container">
                                            ...
                                            <div id="table_data">
                                                <?php echo $__env->make('dashboard.property_types.partials._table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <?php echo $__env->make('dashboard.property_types.modals.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('dashboard.property_types.modals.edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('dashboard.property_types.modals.details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.change_status', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('dashboard.property_types.change.status')); ?>",
                data: {
                ...
                success: function(data) {
                    ...
                    if (data.data.status == 1) {
                        ...
                        $('.property_type_status_' + data.data.id).text("<?php echo __('general.enable'); ?>");
                    } else if (data.data.status == 0) {
                        $('.property_type_status_' + data.data.id).addClass('badge-danger');
                        $('.property_type_status_' + data.data.id).text("<?php echo __('general.disabled'); ?>");
                    }
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rental\resources\views/dashboard/property_types/index.blade.php ENDPATH**/ ?>