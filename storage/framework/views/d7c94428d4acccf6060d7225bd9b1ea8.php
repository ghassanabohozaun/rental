        ...
        <form class="js-filter-form d-flex align-items-center gap-2" data-container="#table_data"
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="keyword_search_popover">
                    <div class="mb-3">
                        <label class="premium-label mb-2"><?php echo __('companies.search_by_name'); ?></label>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($all_companies) && $all_companies->count() > 0): ?>
            <!-- Company Filter -->
            <div class="filter-item">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="premium-input-wrapper">
                            <select name="company_id" id="filter_company_id"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $all_companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/companies/partials/_search.blade.php ENDPATH**/ ?>