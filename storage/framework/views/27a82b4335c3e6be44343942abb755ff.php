    ...
    <div class="app-content content">
        <div class="content-wrapper">
                ...
                <div class="content-header-right col-md-6 col-12 text-md-right">
                    <div class="mb-1">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customers_create')): ?>
                            <a href="<?php echo route('dashboard.customers.create'); ?>" class="btn btn-premium-add shadow-pulse">
                                <i class="fas fa-plus-circle"></i>
                                <?php echo __('customers.add_customer'); ?>
            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-contracts">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['total_customers']); ?></h3>
                                <h6 class="stat-title"><?php echo __('customers.customers'); ?></h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-active">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['active_customers']); ?></h3>
                                <h6 class="stat-title"><?php echo __('customers.active_customers'); ?></h6>
                            </div>
                            <div class="stat-icon-wrapper">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-expiring">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['active_tenants']); ?></h3>
                                <h6 class="stat-title"><?php echo __('customers.active_tenants'); ?></h6>
                            </div>
                            <div class="stat-icon-wrapper">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 mb-2">
                        <div class="premium-stat-card h-100 card-revenue">
                            <div class="stat-content">
                                <h3 class="stat-value"><?php echo e($stats['corporate_customers']); ?></h3>
                                <h6 class="stat-title"><?php echo __('customers.corporate_customers'); ?></h6>
                            </div>
                            <div class="stat-icon-wrapper">
                ...
                <!-- end: stats cards -->
                <?php echo $__env->make('dashboard.customers.partials._search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <div class="card premium-card premium-card-anim">
                                ...
                                <div class="card-header border-0 pb-0">
                                    <h6 class="card-title text-dark font-weight-bold d-flex align-items-center mb-0">
                                        ...
                                        <span id="customersCountBadge" class="badge badge-primary badge-pill badge-glow ml-2 font-11"><?php echo $customers->total(); ?></span>
                                    </h6>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="table-loader-container">
                                            ...
                                            <div id="table_data">
                                                <?php echo $__env->make('dashboard.customers.partials._table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('change', '.change_status', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('dashboard.customers.change.status')); ?>",
                    data: {
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rental\resources\views/dashboard/customers/index.blade.php ENDPATH**/ ?>