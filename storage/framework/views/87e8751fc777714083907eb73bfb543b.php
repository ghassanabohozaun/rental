            ...
            <div class="modal-content premium-modal-content">
                ...
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center" id="editModalLabel">
                        <i class="fas fa-edit text-primary mr-2 icon-size-18"></i> <?php echo __('owners.edit_owner'); ?>
                ...
                <div class="modal-body mt-2 mb-0">
                    ...
                    <div class="row">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user()->company_id == 1): ?>
                            <div class="col-md-12 mb-1">
                                <div class="premium-form-group">
                                    <label class="premium-label" for="company_id_edit"><?php echo __('companies.company'); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_ar_edit"><?php echo __('owners.name'); ?> (<?php echo __('general.ar'); ?>) <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_en_edit"><?php echo __('owners.name'); ?> (<?php echo __('general.en'); ?>) <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="type_edit"><?php echo __('owners.type'); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="identification_number_edit"><?php echo __('owners.identification_number'); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="phone_edit"><?php echo __('owners.phone'); ?></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="email_edit"><?php echo __('owners.email'); ?></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="address_edit"><?php echo __('owners.address'); ?></label>
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="notes_edit"><?php echo __('owners.notes'); ?></label>
                                <textarea class="form-control premium-input shadow-none" id="notes_edit" name="notes" rows="4" placeholder="<?php echo __('owners.notes'); ?>"></textarea>
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/owners/modals/edit.blade.php ENDPATH**/ ?>