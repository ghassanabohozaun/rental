...
<?php $__env->startSection('content'); ?>
    <div class="app-content content">
        <div class="content-wrapper">
                ...
                <div class="content-header-right col-md-6 col-12 text-md-right">
                    <div class="mb-1">
                        <button type="button" class="btn btn-premium-add shadow-pulse" data-toggle="modal"
                            ...
                            <?php echo __('departments.create_new_department'); ?>
            ...
            <?php echo $__env->make('dashboard.departments.partials._search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                ...
                                <div class="card-header border-0 pb-0">
                                    <h6 class="card-title text-dark font-weight-bold d-flex align-items-center mb-0">
                                        ...
                                        <span id="departmentsCountBadge"
                                            class="badge badge-primary badge-pill badge-glow ml-2 font-11"><?php echo $departments->total(); ?></span>
                                    </h6>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body pt-0">
                                        <div class="table-loader-container">
                                            ...
                                            <div id="table_data">
                                                <?php echo $__env->make('dashboard.departments.partials._table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <?php echo $__env->make('dashboard.departments.modals.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('dashboard.departments.modals.edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('dashboard.departments.modals.details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.change_status', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('dashboard.departments.change.status')); ?>",
                data: {
                ...
                success: function(data) {
                    ...
                    if (data.data.status == 1) {
                        ...
                        $('.department_status_' + data.data.id).text("<?php echo __('general.enable'); ?>");
                    } else if (data.data.status == 0) {
                        $('.department_status_' + data.data.id).addClass('badge-danger');
                        $('.department_status_' + data.data.id).text("<?php echo __('general.disabled'); ?>");
                    }
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rental\resources\views/dashboard/departments/index.blade.php ENDPATH**/ ?>