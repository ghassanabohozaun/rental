<div class="modal modal-pop" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form class="form ajax-form" action="<?php echo route('dashboard.guarantors.store'); ?>" method="POST" id='create_form' novalidate
            ...
            <div class="modal-content premium-modal-content">
                ...
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center" id="createModalLabel">
                        <i class="fas fa-user-plus text-primary mr-2 icon-size-18"></i> <?php echo __('guarantors.add_guarantor'); ?>
                ...
                <div class="modal-body mt-2 mb-0">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_ar_create"><?php echo __('guarantors.name'); ?> (<?php echo __('general.ar'); ?>) <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_en_create"><?php echo __('guarantors.name'); ?> (<?php echo __('general.en'); ?>) <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control premium-input shadow-none"
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="id_number_create"><?php echo __('guarantors.id_number'); ?> <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control premium-input shadow-none"
                                    id="id_number_create" name="id_number" placeholder="<?php echo __('guarantors.id_number'); ?>"
                                    autocomplete="off">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="phone_create"><?php echo __('guarantors.phone'); ?> <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control premium-input shadow-none text-left"
                                    id="phone_create" name="phone" placeholder="<?php echo __('guarantors.phone'); ?>"
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="address_create"><?php echo __('guarantors.address'); ?></label>
                                <input type="text" class="form-control premium-input shadow-none"
                                    id="address_create" name="address" placeholder="<?php echo __('guarantors.address'); ?>"
                                    autocomplete="off">
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="notes_create"><?php echo __('guarantors.notes'); ?></label>
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/guarantors/modals/create.blade.php ENDPATH**/ ?>