        ...
        <form class="js-filter-form d-flex align-items-center gap-2" data-container="#table_data"
            ...
            <div class="filter-item">
                <div class="filter-chip js-filter-chip" data-filter-target="user_search_popover">
                    ...
                    <span class="chip-text"><?php echo __('users.users'); ?></span>
                </div>

                <!-- user Search Popover -->
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="user_search_popover">
                    <div class="mb-3">
                        <label class="premium-label mb-2"><?php echo __('users.users'); ?></label>
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/users/partials/_search.blade.php ENDPATH**/ ?>