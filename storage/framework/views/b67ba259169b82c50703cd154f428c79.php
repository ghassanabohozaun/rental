...
<div class="modal modal-pop" id="detailsDepartmentModal" tabindex="-1" role="dialog" aria-labelledby="detailsDepartmentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
            ...
            <div class="modal-body my-2" id="detailsDepartmentModalBody">
...
<?php /**PATH C:\laragon\www\rental\resources\views/dashboard/departments/modals/details.blade.php ENDPATH**/ ?>