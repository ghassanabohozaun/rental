<div class="d-flex align-items-center justify-content-center">
    ...
    @can('cheques_update')
        ...
        @if ($cheque->is_deposit && $cheque->status === 'held')
            ...
            <button type="button" class="btn-premium-action btn-premium-action-warning mr-1 btn-return-cheque"
                data-id="{!! $cheque->id !!}" title="{!! __('cheques.return_cheque') !!}">
                <i class="fas fa-undo"></i>
            </button>

            {{-- Cash Insurance Cheque --}}
            <button type="button" class="btn-premium-action btn-premium-action-success mr-1 btn-cash-cheque"
