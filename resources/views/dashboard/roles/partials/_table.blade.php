                ...
                <tr id="row{{ $role->id }}" class="premium-table-row pointer" data-row-title="صلاحية | {!! $role->name !!}">
                    ...
                    <td class="align-middle property-info-td font-weight-bold text-primary">
                        ...
                        <div class="row-subtitle-html d-none">
                            <span class="text-muted"><i class="fas fa-briefcase mr-25 opacity-5"></i> {!! optional($role->company)->name ?? __('roles.global_role') !!}</span>
                            <span class="text-muted mx-50">|</span>
                            <span class="text-muted"><i class="fas fa-user-plus mr-25 opacity-5"></i> {!! $role->creator->name ?? '---' !!}</span>
                        </div>
