...
<div class="modal modal-pop fade" id="detailsCompanyModal" tabindex="-1" role="dialog" aria-labelledby="detailsCompanyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
            ...
            <div class="modal-body" id="detailsCompanyModalBody">
