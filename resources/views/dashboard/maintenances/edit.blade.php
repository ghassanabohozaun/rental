                                                ...
                                                <div class="col-md-3">
                                                    <div class="premium-form-group">
                                                        ...
                                                        <div class="input-group premium-input-group">
                                                            <input type="number" step="0.01" id="main_cost" name="cost" class="form-control premium-input shadow-none border-right-0" value="{{ $maintenance->cost ?? '0.00' }}">
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body pt-3">
                                            ...
                                            <div id="items-container">
                                                <div id="empty-items-message" class="text-center p-3 text-dark font-weight-bold" style="display: {{ count($maintenance->items) > 0 ? 'none' : 'block' }};">
                                                    <i class="fas fa-info-circle mr-1 text-primary"></i>
                                                    {!! __('maintenances.no_maintenance_items_added') !!}
                                                </div>
                                                @php $itemIndex = 0; @endphp
                                                @forelse($maintenance->items as $item)
                                                    <div class="maintenance-item-row align-all-items-row row align-items-start mb-2 pb-2 border-bottom" id="item-row-{{$itemIndex}}">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="premium-form-group mb-0">
                                                                ...
                                                                <div class="input-group premium-input-group">
                                                                    <input type="number" step="0.01" name="items[{{$itemIndex}}][cost]" class="form-control premium-input shadow-none border-right-0 item-cost" value="{{ $item->cost }}">
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text bg-white border-left-0 text-muted">{{ currency() }}</span>
                                                                    </div>
                                                                </div>
