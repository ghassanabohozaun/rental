...
@section('content')
    <div class="app-content content">
        <form class="form ajax-form" id='myForm' action="{!! route('dashboard.maintenances.update', $maintenance->id) !!}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="card premium-card shadow-lg border-0 premium-card-anim">
                                    <div class="property-mandatory-header">
                                        <div class="title-wrapper">
                                            ...
                                            <span>{!! __('maintenances.update_maintenance') !!}</span>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="premium-form-group">
                                                            ...
                                                            <select id="company_id" name="company_id" class="form-control premium-input shadow-none select2">
                                                                ...
                                                                @foreach ($companies as $company)
                                                                    <option value="{{ $company->id }}" {{ $maintenance->company_id == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3">
                                                    <div class="premium-form-group">
                                                        ...
                                                        <select id="property_id" name="property_id" class="form-control premium-input shadow-none select2-ajax" data-url="{!! route('dashboard.properties.autocomplete') !!}" data-placeholder="{!! __('properties.choose_property') !!}" @if(user()->company_id == 1 && !$maintenance->company_id) disabled @endif>
                                                            @if($maintenance->property)
                                                                <option value="{{ $maintenance->property->id }}" selected>{{ $maintenance->property->name }}</option>
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="premium-form-group">
                                                        ...
                                                        <select id="status" name="status" class="form-control premium-input shadow-none select2">
                                                            ...
                                                            <option value="pending" {{ $maintenance->status == 'pending' ? 'selected' : '' }}>{!! __('maintenances.pending') !!}</option>
                                                            <option value="in_progress" {{ $maintenance->status == 'in_progress' ? 'selected' : '' }}>{!! __('maintenances.in_progress') !!}</option>
                                                            <option value="done" {{ $maintenance->status == 'done' ? 'selected' : '' }}>{!! __('maintenances.done') !!}</option>
                                                        </select>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="premium-form-group">
                                                        ...
                                                        <input type="number" step="0.01" id="main_cost" name="cost" class="form-control premium-input shadow-none bg-light" value="{{ $maintenance->cost ?? '0.00' }}" readonly>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-6">
                                                    <div class="premium-form-group">
                                                        ...
                                                        <textarea id="description_ar" name="description_ar" rows="3" class="form-control premium-input shadow-none" placeholder="{!! __('maintenances.enter_description_ar') !!}">{!! $maintenance->getTranslation('description', 'ar') !!}</textarea>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="premium-form-group">
                                                        ...
                                                        <textarea id="description_en" name="description_en" rows="3" class="form-control premium-input shadow-none" placeholder="{!! __('maintenances.enter_description_en') !!}">{!! $maintenance->getTranslation('description', 'en') !!}</textarea>
                                                    ...
                                                    <div class="maintenance-item-row row align-items-start mb-2 pb-2 border-bottom">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="premium-form-group mb-0">
                                                                ...
                                                                <input type="text" name="items[{{$itemIndex}}][type]" class="form-control premium-input shadow-none" placeholder="{!! __('maintenances.enter_type') !!}" value="{{ $item->type }}">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="premium-form-group mb-0">
                                                                ...
                                                                <input type="number" step="0.01" name="items[{{$itemIndex}}][cost]" class="form-control premium-input shadow-none item-cost" value="{{ $item->cost }}">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="premium-form-group mb-0">
                                                                ...
                                                                <div class="d-flex align-items-center" style="height: 38px; margin-top: 5px;">
                                                                        ...
                                                                        <label for="attachment_{{$itemIndex}}" class="premium-file-label w-100 mb-0">
                                                                            <div class="premium-file-box w-100 d-flex align-items-center justify-content-between" style="min-height: 38px !important; height: 38px !important; padding: 5px 10px !important; border-radius: 2px !important;">
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <span class="file-name text-muted text-truncate" style="max-width: 140px; display: inline-block;">
                                                                                        {{ $item->attachment ? $item->attachment : __('general.choose_file') }}
                                                                                    </span>
                                                                                </div>
                                                                    ...
                                                                    @if($item->attachment)
                                                                        <a href="{{ asset('uploads/maintenances/'.$item->attachment) }}" target="_blank" class="btn-premium-action btn-premium-action-info mx-1" title="{!! __('maintenances.view_current_attachment') !!}" style="height: 38px; width: 38px; display: inline-flex; align-items: center; justify-content: center; margin: 0 4px;">
