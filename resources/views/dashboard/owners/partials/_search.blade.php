        ...
        <form class="js-filter-form d-flex align-items-center flex-wrap" style="gap: 12px;" data-container="#table_data"
            ...
            <div class="filter-item">
                <div class="filter-chip js-filter-chip" data-filter-target="owner_search_popover">
                    ...
                    <span class="chip-text">{!! __('owners.owners') !!}</span>
                </div>

                <!-- Owner Search Popover -->
                <div class="filter-query-panel shadow-lg border-0 radius-16" id="owner_search_popover">
                    <div class="mb-3">
                        <label class="premium-label mb-2">{!! __('owners.owners') !!}</label>
