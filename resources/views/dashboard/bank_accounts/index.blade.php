                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb premium-breadcrumb shadow-sm">
                                ...
                                <li class="breadcrumb-item active">
                                    <i class="la la-bank mr-1 pointer-events-none"></i> {!! __('bank_accounts.bank_accounts') !!}
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card premium-card">
                                ...
                                <div class="card-header border-0 pb-0">
                                    <h4 class="card-title text-dark font-weight-bold d-flex align-items-center">
                                        <i class="la la-bank text-primary mr-2 font-24"></i>
                                        {!! __('bank_accounts.bank_accounts') !!}
                                        <span class="badge badge-primary badge-pill badge-glow ml-2 font-11">{!! $bankAccounts->total() !!}</span>
                                    </h4>
