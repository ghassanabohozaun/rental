            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-end mb-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <a href="javascript:void(0);" class="text-primary font-small-3 font-weight-bold text-nowrap" id="select_all_customers" style="white-space: nowrap;">
                                    <i class="fas fa-check-double"></i> {!! __('reports.select_all') !!}
                                </a>
                                <a href="javascript:void(0);" class="text-danger font-small-3 font-weight-bold text-nowrap ml-2" id="deselect_all_customers" style="white-space: nowrap;">
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-end mb-1">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a href="javascript:void(0);" class="text-primary font-small-3 font-weight-bold text-nowrap" id="select_all_statuses" style="white-space: nowrap;">
                                    <i class="fas fa-check-double"></i> {!! __('reports.select_all') !!}
                                </a>
                                <a href="javascript:void(0);" class="text-danger font-small-3 font-weight-bold text-nowrap" id="deselect_all_statuses" style="white-space: nowrap;">
                                    <i class="fas fa-times"></i> {!! __('reports.deselect_all') !!}
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 mb-2">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="amount_from" name="amount_from" placeholder="0.00">
                    </div>
                </div>
                <div class="col-md-3 mb-2">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="amount_to" name="amount_to" placeholder="0.00">
                    </div>
                </div>
