    ...
    <div class="btn-group" role="group">
        ...
        @can('departments_update')
            <a href="javascript:void(0)" class="btn-premium-action btn-premium-action-edit mr-1 edit_department_button"
                ...
                department-name-en="{!! $department->getTranslation('name', 'en') !!}" department-company-id="{!! $department->company_id !!}"
                department-company-name="{!! optional($department->company)->name !!}" title="{!! __('general.edit') !!}">
