    ...
    <div class="query-bar js-query-bar">
        ...
        <form class="js-filter-form d-flex align-items-center gap-2" data-container="#table_data" data-loader=".table-loader-overlay">
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="status_search_popover" style="min-width: 280px;">
                    <div class="mb-3">
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="type_search_popover" style="min-width: 280px;">
                    <div class="mb-3">
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="area_search_popover" style="min-width: 280px;">
                    <div class="mb-3">
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="price_search_popover" style="min-width: 280px;">
                    <div class="mb-3">
                        <label class="premium-label mb-1 small text-muted">{!! __('general.min') !!}</label>
                        <div class="premium-input-wrapper">
