            ...
            <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
                ...
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center" id="updateproperty_typeModalLabel">
                        <i class="fas fa-edit text-primary mr-2 icon-size-18"></i> {!! __('property_types.update_property_type') !!}
                    </h6>
                ...
                <div class="modal-body mt-2 mb-0">
                    <div class="row">
                        @if (isset($companies))
                            <div class="col-md-12 mb-2">
                                <div class="premium-form-group">
                                    <label class="premium-label" for="company_id_dept_edit">{!! __('companies.company') !!}
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_ar_edit">{!! __('property_types.name_ar') !!} <span
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_en_edit">{!! __('property_statuses.name_en') !!} <span
                                        class="text-danger">*</span></label>
                                <div class="premium-input-wrapper">
