            ...
            <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
                ...
                <div class="modal-body my-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="premium-form-group">
                                    <label for="company_id_dept_create">{!! __('companies.company') !!}<span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="premium-form-group">
                                <label for="name_ar_create">{!! __('property_types.name_ar') !!} <span
                                        class="text-danger">*</span></label>
                                <div class="premium-input-wrapper">
                        ...
                        <div class="col-md-6">
                            <div class="premium-form-group">
                                <label for="name_en_create">{!! __('property_types.name_en') !!} <span
                                        class="text-danger">*</span></label>
                                <div class="premium-input-wrapper">
