    ...
    <div class="btn-group" role="group">
        ...
        @can('property_types_update')
            <a href="javascript:void(0)" class="btn-premium-action btn-premium-action-edit mr-1 edit_property_type_button"
                ...
                property_type-name-en="{!! $property_type->getTranslation('name', 'en') !!}" property_type-company-id="{!! $property_type->company_id !!}"
                property_type-company-name="{!! optional($property_type->company)->name !!}" title="{!! __('general.edit') !!}">
