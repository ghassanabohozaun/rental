    ...
    <div class="btn-group" role="group">
        ...
        @can('property_statuses_update')
            <a href="javascript:void(0)" class="btn-premium-action btn-premium-action-edit mr-1 edit_property_status_button"
                ...
                property_status-name-en="{!! $property_status->getTranslation('name', 'en') !!}" property_status-color="{!! $property_status->color !!}"
                property_status-company-id="{!! $property_status->company_id !!}" property_status-company-name="{!! optional($property_status->company)->name !!}"
