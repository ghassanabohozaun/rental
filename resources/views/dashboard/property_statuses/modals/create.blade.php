            ...
            <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
                ...
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title font-weight-bold text-dark" id="createproperty_statusModalLabel">
                        <i class="fas fa-plus-circle mr-1 text-primary" style="font-size: 22px;"></i>
                ...
                <div class="modal-body my-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="premium-form-group">
                                    <label for="company_id_dept_create">{!! __('property_statuses.company') !!} <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="premium-form-group">
                                <label for="name_ar_create">{!! __('property_statuses.name_ar') !!} <span
                                        class="text-danger">*</span></label>
                                <div class="premium-input-wrapper">
                        ...
                        <div class="col-md-6">
                            <div class="premium-form-group">
                                <label for="name_en_create">{!! __('property_statuses.name_en') !!} <span
                                        class="text-danger">*</span></label>
                                <div class="premium-input-wrapper">
