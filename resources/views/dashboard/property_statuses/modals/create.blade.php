<div class="modal modal-pop" id="createproperty_statusModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form class="form ajax-form" action="{!! route('dashboard.property_statuses.store') !!}" method="POST" enctype="multipart/form-data"
            id='create_property_status_form' novalidate data-success-msg="{!! __('general.add_success_message') !!}"
            ...
            <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
                ...
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center"
                        ...
                        <i class="fas fa-plus-circle text-primary mr-2 icon-size-18"></i> {!! __('property_statuses.create_new_property_status') !!}
                    </h6>
                ...
                <div class="modal-body mt-2 mb-0">
                    <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="premium-form-group">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <label class="premium-label mb-0" for="company_id_dept_create">{!! __('property_statuses.company') !!}</label>
                                    ...
                                    <select name="company_id" id="company_id_dept_create"
                                        ...
                                        <option value="" selected>{{ __('general.select_from_list') }}
                                        </option>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_ar_create">{!! __('property_statuses.name_ar') !!} <span
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_en_create">{!! __('property_statuses.name_en') !!} <span
                                        class="text-danger">*</span></label>
                                <div class="premium-input-wrapper">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-12">
                            <div class="premium-form-group mb-0">
                                <label class="premium-label mb-3">{!! __('property_statuses.color') !!} <span
                                        class="text-danger">*</span></label>
