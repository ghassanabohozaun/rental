            ...
            <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
                ...
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title font-weight-bold text-dark d-flex align-items-center" id="updateproperty_statusModalLabel">
                        <i class="fas fa-edit text-primary mr-2 icon-size-18"></i> {!! __('property_statuses.update_property_status') !!}
                    </h6>
                ...
                <div class="modal-body mt-2 mb-0">
                    <div class="row">
                        ...
                        @if (isset($companies))
                            <div class="col-md-12 mb-2">
                                <div class="premium-form-group">
                                    <label class="premium-label" for="company_id_dept_edit">{!! __('property_statuses.company') !!} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_ar_edit">{!! __('property_statuses.name_ar') !!} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="premium-form-group">
                                <label class="premium-label" for="name_en_edit">{!! __('property_statuses.name_en') !!} <span class="text-danger">*</span></label>
                                <div class="premium-input-wrapper">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-12">
                            <div class="premium-form-group mb-0">
                                <label class="premium-label mb-3">{!! __('property_statuses.color') !!} <span class="text-danger">*</span></label>
