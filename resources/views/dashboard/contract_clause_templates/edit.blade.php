...
<div class="app-content content">
    <form class="form ajax-form" action="{{ route('dashboard.contract_clause_templates.update', $template->id) }}" method="post" data-success-action="redirect" data-redirect-url="{{ route('dashboard.contract_clause_templates.index') }}">
        @csrf
        @method('PUT')
                ...
                <div class="content-header-right col-md-6 col-12 text-md-right mb-2">
                    <div class="d-flex justify-content-md-end justify-content-center gap-2">
                        ...
                        <button type="submit" class="btn btn-premium-save">
                            <i class="fas fa-save mr-2"></i> {!! __('contracts.save_changes') !!}
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body pt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="company_id" class="form-control select2">
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}" {{ $template->company_id == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="premium-form-group">
                                    ...
                                    <input type="text" name="title" class="form-control premium-input shadow-none" value="{{ $template->title }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="premium-form-group">
                                    <label class="premium-label">{!! __('contracts.order_num_hint') !!} <span class="text-danger">*</span></label>
                                    <input type="number" name="order_num" class="form-control premium-input shadow-none" value="{{ $template->order_num }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="premium-form-group">
                                    ...
                                    <textarea name="content" class="form-control premium-input shadow-none" rows="10">{{ $template->content }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group d-flex align-items-center">
                                    <div class="custom-control custom-switch mr-2" style="margin-left: 10px;">
                                        <input type="checkbox" class="custom-control-input" id="status" name="status" value="1" {{ $template->status ? 'checked' : '' }}>
