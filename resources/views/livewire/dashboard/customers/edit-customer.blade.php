                ...
                <div class="col-12">
                    ...
                    <div class="card premium-card mb-2 premium-card-anim">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="premium-form-group @error('tenant_type') is-invalid-premium @enderror">
                                        ...
                                        <div wire:ignore>
                                            <select id="tenant_type" wire:model.live="tenant_type"
                                                ...
                                                <option value="individual" @if ($tenant_type == 'individual') selected @endif>{!! __('customers.individual') !!}</option>
                                                <option value="company" @if ($tenant_type == 'company') selected @endif>{!! __('customers.company') !!}</option>
                                            </select>
                                        </div>
                                        @error('tenant_type')
                                            <span class="text-danger error-text">{{ $message }}</span>
                            ...
                            @if ($tenant_type)
                                <div class="tenant-details-wrapper mt-2">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <div class="premium-form-group @error('nationality_id') is-invalid-premium @enderror">
                                                <label class="premium-label">{!! __('customers.nationality') !!} <span
                                                        class="text-danger">*</span></label>
                                                <div wire:ignore wire:key="nationality-select-wrapper-{{ $tenant_type }}">
        ...
        $(document).ready(function() {
            function initSelects() {
                $('.select2:not(.ajax-select)').each(function() {
                    let $this = $(this);
                    let model = $this.attr('wire:model.defer') || $this.attr('wire:model.lazy') || $this.attr('wire:model.live') || $this.attr('wire:model');
                    $this.select2({
                        width: '100%',
