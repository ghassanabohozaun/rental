                ...
                <section id="basic-form-layouts">
                    <div class="row align-items-start">
                        <div class="col-lg-8 col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-2"
                                                ...
                                                <div
                                                    ...
                                                    <div wire:ignore wire:key="contract-id-wrapper">
                                                        <select
                                                            class="form-control premium-input shadow-none js-select2 opacity-75"
                                            ...
                                            <div class="col-md-12"
                                                ...
                                                <div
                                                    ...
                                                    <div wire:ignore wire:key="bank-id-wrapper">
                                                        <select
                                ...
                                <div class="card premium-card mb-2">
                                    ...
                                    <div class="card-body {{ !$contract_id ? 'opacity-50 pointer-events-none' : '' }}">
                                        @if ($amountExceedsRemaining)
                                            <div class="alert alert-premium-warning premium-fade-in d-flex align-items-center mb-3 border-0 shadow-sm"
                                                style="border-radius: 12px; background-color: #fff3cd;">
                                                <i
                                                    class="fas fa-exclamation-triangle font-large-1 mr-2 text-warning"></i>
                                                <div>
                                                    <strong class="text-warning">{!! __('cheques.amount_exceeds_contract_remaining') !!}
                                                        ({{ number_format($availableToCover, 2) }}
                                                        {{ currency() }})</strong>
                                                </div>
                                            </div>
                                        @endif
                                                ...
                                                <div
                                                    ...
                                                    <div class="input-group premium-input-group">
                                                        <input type="number" step="0.01"
                                                            class="form-control premium-input shadow-none border-right-0 {{ $currentChequeUsedAmount > 0 ? 'opacity-75' : '' }}"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div
                                                    ...
                                                    <label for="status">{!! __('cheques.status') !!} <span
                                                            class="text-danger">*</span></label>
                                                    <div wire:ignore wire:key="status-wrapper-enabled">
                                                        <select
                                                            class="form-control premium-input shadow-none js-select2"
                            ...
                            <!-- Card 3: Bank & Owner -->
                            <div class="" wire:key="card-3-wrapper-{{ $validation_fail_nonce }}">
                                <div class="card premium-card mb-2">
                                    <div class="premium-mandatory-header py-2">
                                        <div class="title-wrapper">
