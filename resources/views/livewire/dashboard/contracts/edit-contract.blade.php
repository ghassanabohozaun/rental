                                            ...
                                            <div class="premium-mandatory-section mb-4">
                                                <div class="premium-mandatory-header d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="text-right">
                                                        <span class="badge badge-light-warning py-1 px-2" style="font-size: 0.75rem; border: 1px dashed #ffc107; border-radius: 6px;">
                                                            <i class="fas fa-lock mr-1 text-warning"></i> {!! __('contracts.deposit_locked_help') !!}
                                                        </span>
                                                    </div>
                                                    @endif
                                                </div>
                                                <div class="premium-mandatory-body {{ $this->isDepositLocked ? 'pointer-events-none opacity-50' : '' }}">
                                                    <div class="row">
                                                        <div class="col-md-4 mb-2">
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <div class="premium-form-group @error('deposit_type') is-invalid-premium @enderror {{ $deposit_amount <= 0 ? 'pointer-events-none opacity-50' : '' }}">
                                                                ...
                                                                <div>
                                                                    <select id="deposit_type" wire:model.live="deposit_type" class="form-control premium-input shadow-none" {{ $this->isDepositLocked ? 'disabled' : '' }}>
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <div class="premium-form-group @error('deposit_status') is-invalid-premium @enderror {{ $deposit_type == 'cash' ? 'pointer-events-none opacity-50' : '' }}">
                                                                ...
                                                                <div>
                                                                    <select id="deposit_status" wire:model="deposit_status" class="form-control premium-input shadow-none" {{ $this->isDepositLocked ? 'disabled' : '' }}>
                                                        ...
                                                        <div class="col-md-3 mb-2">
                                                            <div class="premium-form-group @error('deposit_bank_name.ar') is-invalid-premium @enderror">
                                                                ...
                                                                <input type="text" id="deposit_bank_name_ar" wire:model="deposit_bank_name.ar"
                                                                    class="form-control premium-input shadow-none" autocomplete="off" placeholder="{!! __('cheques.bank_name') !!} ({!! __('general.ar') !!})" {{ $this->isDepositLocked ? 'disabled' : '' }}>
                                                        ...
                                                        <div class="col-md-3 mb-2">
                                                            <div class="premium-form-group @error('deposit_bank_name.en') is-invalid-premium @enderror">
                                                                ...
                                                                <input type="text" id="deposit_bank_name_en" wire:model="deposit_bank_name.en"
                                                                    class="form-control premium-input shadow-none" autocomplete="off" placeholder="{!! __('cheques.bank_name') !!} ({!! __('general.en') !!})" {{ $this->isDepositLocked ? 'disabled' : '' }}>
                                                        ...
                                                        <div class="col-md-3 mb-2">
                                                            <div class="premium-form-group @error('deposit_cheque_owner_name.ar') is-invalid-premium @enderror">
                                                                ...
                                                                <input type="text" id="deposit_cheque_owner_name_ar" wire:model="deposit_cheque_owner_name.ar"
                                                                    class="form-control premium-input shadow-none" autocomplete="off" placeholder="{!! __('cheques.cheque_owner_name') !!} ({!! __('general.ar') !!})" {{ $this->isDepositLocked ? 'disabled' : '' }}>
                                                        ...
                                                        <div class="col-md-3 mb-2">
                                                            <div class="premium-form-group @error('deposit_cheque_owner_name.en') is-invalid-premium @enderror">
                                                                ...
                                                                <input type="text" id="deposit_cheque_owner_name_en" wire:model="deposit_cheque_owner_name.en"
                                                                    class="form-control premium-input shadow-none" autocomplete="off" placeholder="{!! __('cheques.cheque_owner_name') !!} ({!! __('general.en') !!})" {{ $this->isDepositLocked ? 'disabled' : '' }}>
