                                    ...
                                    <div class="maintenance-item-row align-all-items-row row align-items-start mb-2 pb-2 border-bottom" wire:key="attachment-{{ $index }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="premium-form-group mb-0 @error('property_attachments.'.$index.'.file') is-invalid-premium @enderror">
                                                <label class="premium-label">{!! __('properties.attachment') !!} @if(empty($attachment['existing_file']))<span class="text-danger">*</span>@endif</label>
                                                <div class="d-flex align-items-center w-100">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <span class="file-name text-muted text-truncate d-inline-block">
                                                                        ...
                                                                        @elseif (!empty($attachment['existing_file']))
                                                                            <span class="text-success font-weight-bold">{{ basename($attachment['existing_file']) }}</span>
                                                                        @else
                                                    ...
                                                    @elseif (!empty($attachment['existing_file']))
                                                        <div class="file-preview-container mx-1 d-flex align-items-center">
                                                            <a href="{{ Storage::disk('properties')->url($attachment['existing_file']) }}" target="_blank" class="btn-premium-action btn-premium-action-info mx-1" title="{!! __('general.view') !!}">
                                                                <i class="fas fa-external-link-alt"></i>
                                                            </a>
                                                            <a href="{{ Storage::disk('properties')->url($attachment['existing_file']) }}" download target="_blank" class="btn-premium-action btn-premium-action-success mx-1" title="{!! __('general.download') ?? 'تحميل' !!}">
