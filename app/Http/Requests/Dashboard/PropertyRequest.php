...
class PropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'electricity_account_number' => ['required', 'string', 'max:255', Rule::unique('properties', 'electricity_account_number')->where('company_id', $company_id)->ignore($this->property)],
            'water_account_number' => ['required', 'string', 'max:255', Rule::unique('properties', 'water_account_number')->where('company_id', $company_id)->ignore($this->property)],
